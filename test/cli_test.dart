...
<dhcpd>
  ...
  test('allFormats', () {
    //TODO: Repeat this for each input format - write function that repeats it
    ...
    validateAllOutputFromSourceFile(
      uprt,
      isCorrectLeaseMapLength,
      "test/test-data/*.ddwrt",
    );

    validateAllOutputFromSourceFile(
      uprt,
      isCorrectLeaseMapLength,
      "test/test-data/*-opn.xml",
    );
    validateAllOutputFromSourceFile(
      uprt,
      isCorrectLeaseMapLength,
      "test/test-data/*.openwrt",
    );

    validateAllOutputFromSourceFile(
      uprt,
      isCorrectLeaseMapLength,
      "test/test-data/*-pfs.xml",
    );
...
void validateAllOutputFromSourceFile(
    Converter uprt,
    bool isCorrectLeaseMapLength(
        Map<String, List<String>> leaseMap, int listLength),
